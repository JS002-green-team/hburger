...
if (orders) {
    ...
    orderDetails.forEach(el => {
        ...
        let cont = el as HTMLButtonElement;
       
        el.addEventListener("click", (e) => {
            let modal = orders?.querySelector("#order-modal h3") as HTMLHeadingElement;
            modal.innerText = "Olá eu sou o modal " + cont.dataset.pedido;
            iniciaModal("order-modal");
...
function createOrderTicket(el: isOrder) {
    let li = `<li>
        ...
        <div class="actions">
            ...
            <button type="button" aria-label="Detalhes" class="details" data-pedido="${el.id}">
